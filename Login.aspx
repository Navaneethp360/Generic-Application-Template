...
<head runat="server">
    ...
    filter: blur(1.8px);
    z-index: -1;
    transform: scale(1.05); /* avoids edges showing through */
}
        .login-page {
            width: 100%;
            max-width: 1200px;
...
<div class="login-branding" style="text-align: center; align-items:center">
    ...
    <div class="login-logo">Generic Directory System</div>
    <div class="login-tagline">Comprehensive Directory Management Solution</div>
    <div class="login-features">
        <div class="feature-item">
            <div class="feature-icon">✓</div>
            <div>Secure Records Management</div>
        </div>
        <div class="feature-item">
            <div class="feature-icon">✓</div>
        ...
        <div class="feature-item">
            ...
            <div class="login-form-container">
                <div class="login-form">
                    ...
                    <div class="footer">
                        <p>&copy; <%= DateTime.Now.Year %> Generic Directory System</p>
                        <p>
